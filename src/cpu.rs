...
impl Cpu {
    ...
    pub fn decode(&mut self, bus: &mut Peripherals) {
        match self.ctx.opcode {
            ...
            0xC7 => self.rst_addr(bus, 0x00),
            0xD7 => self.rst_addr(bus, 0x10),
            0xE7 => self.rst_addr(bus, 0x20),
            0xF7 => self.rst_addr(bus, 0x30),
            ...
            0xCF => self.rst_addr(bus, 0x08),
            0xDF => self.rst_addr(bus, 0x18),
            0xEF => self.rst_addr(bus, 0x28),
            0xFF => self.rst_addr(bus, 0x38),
            0x76 => self.halt(bus),
            0xF3 => self.di(bus),
            0xFB => self.ei(bus),
